...
yt = Solow_Model_Simulation_Results$A * Solow_Model_Simulation_Results$Simulated_k_t
...
Ytss = Solow_Model_Simulation_Results$A * Solow_Model_Simulation_Results$Ktss
Solow_Model_Simulation_Results$Ytss = Ytss

df = data.frame(Solow_Model_Simulation_Results)
write.csv(df, "Solow_Model_Simulation_Results_Part3Updated")
